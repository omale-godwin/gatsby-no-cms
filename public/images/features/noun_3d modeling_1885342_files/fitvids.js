...
$this.wrap('<div class="fluid-width-video-wrapper"></div>').parent('.fluid-width-video-wrapper').css('padding-top',(aspectRatio*100)+"%");$this.removeAttr('height').removeAttr('width');});});}})(jQuery);jQuery(document).ready(function($){$(".post-video, .video-embed, #portfolio-video, .widget_embed").fitVids();});