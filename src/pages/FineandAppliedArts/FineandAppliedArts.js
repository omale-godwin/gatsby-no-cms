...
import data from '../../categories/fine_and_applied_arts.json'
import './link.css'
const FineandAppliedArts = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/FineandAppliedArts/FineandAppliedArtsPost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default FineandAppliedArts
