...
import data from '../../categories/international_and_diplomatic_studies.json'

export class INTERNATIONALRELATIONSPost extends Component {
  constructor (){
    super()
    this.state = {
    postid: ''
...
export default INTERNATIONALRELATIONSPost