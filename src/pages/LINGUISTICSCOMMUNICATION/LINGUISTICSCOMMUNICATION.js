...
import data from '../../categories/LINGUISTICSCOMMUNICATION.json'
import './link.css'
const LINGUISTICSCOMMUNICATION = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/LINGUISTICSCOMMUNICATION/LINGUISTICSCOMMUNICATIONPost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default LINGUISTICSCOMMUNICATION
