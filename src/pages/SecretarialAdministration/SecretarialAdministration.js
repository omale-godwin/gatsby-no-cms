...
import data from '../../categories/secretarial_administration.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const SecretarialAdministration = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/SecretarialAdministration/SecretarialAdministrationPost?title=${title}&id=${e}`)
  }
...
export default SecretarialAdministration
