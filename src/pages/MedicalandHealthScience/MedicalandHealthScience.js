...
import data from '../../categories/history_project.json'
import './link.css'
const MedicalandHealthScience = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/MedicalandHealthScience/MedicalandHealthSciencePost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default MedicalandHealthScience
