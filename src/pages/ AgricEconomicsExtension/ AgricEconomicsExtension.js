...
import data from '../../categories/agric_economics_and_extension_project.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const  AgricEconomicsExtension = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/ AgricEconomicsExtension/ AgricEconomicsExtensionPost?title=${title}&id=${e}`)
  }
...
export default  AgricEconomicsExtension
