...
import data from '../../categories/science_lab_technology_project.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const SCIENCELABORATORYTECHNOLOGY = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/SCIENCELABORATORYTECHNOLOGY/SCIENCELABORATORYTECHNOLOGYPost?title=${title}&id=${e}`)
  }
...
export default SCIENCELABORATORYTECHNOLOGY
