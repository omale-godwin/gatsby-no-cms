...
import data from '../../categories/industrial_chemistry_project.json'
import './link.css'
const IndustrialChemistry = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/IndustrialChemistry/IndustrialChemistryPost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default IndustrialChemistry
