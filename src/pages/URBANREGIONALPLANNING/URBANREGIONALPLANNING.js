...
import data from '../../categories/urban_and_regional_planning.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const URBANREGIONALPLANNING = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/URBANREGIONALPLANNING/URBANREGIONALPLANNINGPost?title=${title}&id=${e}`)
  }
...
export default URBANREGIONALPLANNING
