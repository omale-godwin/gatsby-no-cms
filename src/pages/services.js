...
const Services = props => {
  ...
  return (
            ...
            <div className="card-content">
                <div className="card-body"> <img className="img" src="https://i.imgur.com/S7FJza5.png" />
                    ...
                    <div className="card-subtitle">
                        ...
                        <Link to="/Source" className="serbtn btn btn-primary">Source Code</Link>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="card-content">
                <div className="card-body"> <img className="img" src="https://i.imgur.com/xUWJuHB.png" />
                    ...
                    <div className="card-subtitle">
                        ...
                        <Link to="/contacts" className="serbtn btn btn-primary">Make Enquiry</Link>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="card-content">
                <div className="card-body"> <img className="img rck" src="https://i.imgur.com/rG3CGn3.png" />
                    ...
                    <div className="card-subtitle">
                        ...
                        <Link to="/hirewriter" className="serbtn btn btn-primary">Hire A Writer</Link>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="card-content">
                <div className="card-body"> <img className="img" src="https://i.imgur.com/xUWJuHB.png" />
                    ...
                    <div className="card-subtitle">
                        ...
                        <Link to="/request" className="serbtn btn btn-primary">Make Request</Link>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="ft">
        ...
        <Link to="/" className="btn btn-primary">View All Department Project</Link>
    </div>
</div>
    </Layout>
  );
