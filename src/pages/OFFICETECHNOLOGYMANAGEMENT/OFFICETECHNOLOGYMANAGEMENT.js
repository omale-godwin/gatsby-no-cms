...
import data from '../../categories/office_technology_management_project.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const OFFICETECHNOLOGYMANAGEMENT = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/OFFICETECHNOLOGYMANAGEMENT/OFFICETECHNOLOGYMANAGEMENTPost?title=${title}&id=${e}`)
  }
...
export default OFFICETECHNOLOGYMANAGEMENT
