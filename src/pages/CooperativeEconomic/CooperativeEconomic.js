...
import data from '../../categories/cooperative_economic_project.json'
import './link.css'
const CooperativeEconomic = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/CooperativeEconomic/CooperativeEconomicPost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default CooperativeEconomic
