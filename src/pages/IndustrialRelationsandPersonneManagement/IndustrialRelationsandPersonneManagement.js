...
import data from '../../categories/industrial_relations_and_personnel_management.json'
import './link.css'
const IndustrialRelationsandPersonneManagement = () => {
...
console.log(posts);
  function singlepage(e, title) {
    console.log(e);
    navigate(`/IndustrialRelationsandPersonneManagement/IndustrialRelationsandPersonneManagementPost?title=${title}&id=${e}`)
  }
  return ( 
  <Layout>
...
export default IndustrialRelationsandPersonneManagement
