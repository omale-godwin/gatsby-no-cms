...
const PURCHASINGSUPPLYCHAINMANAGEMENT = ({ data }) => {
  ...
  console.log(sessionStorage.getItem('postid'))
     navigate(`/PURCHASINGSUPPLYCHAINMANAGEMENT/PURCHASINGSUPPLYCHAINMANAGEMENTPost?id=${e}`)
...
export const pageQuery = graphql`
  query PURCHASINGSUPPLYCHAINMANAGEMENT {
