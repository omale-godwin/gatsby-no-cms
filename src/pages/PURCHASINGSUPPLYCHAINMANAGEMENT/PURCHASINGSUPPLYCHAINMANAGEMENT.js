...
import data from '../../categories/purchasing_and_supply.json'
import Paginaion from '../../components/Paginaion';
import './link.css'
const PURCHASINGSUPPLYCHAINMANAGEMENT = () => {
 ...
 let index = 0;
  ...
  function singlepage(e, title) {
    console.log(e);
    navigate(`/PURCHASINGSUPPLYCHAINMANAGEMENT/PURCHASINGSUPPLYCHAINMANAGEMENTPost?title=${title}&id=${e}`)
  }
...
export default PURCHASINGSUPPLYCHAINMANAGEMENT
